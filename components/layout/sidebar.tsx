...
export function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "h-full bg-sidebar text-sidebar-foreground flex flex-col border-r border-border transition-all duration-200",
    ...
    >
      ...
      <div className="mx-3 mb-3 rounded-2xl border border-border bg-muted p-3">
        {!collapsed && (
